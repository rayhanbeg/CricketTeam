...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-green-50 to-white dark:from-gray-900 dark:to-gray-800 pt-16">
      <motion.div
